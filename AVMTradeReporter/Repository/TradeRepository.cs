                ...
                Template = new IndexTemplateMapping
                {
                    Mappings = new TypeMapping
                    {
                        Properties = new Properties
                        {
                            ...
                            { "valueUSD", new DoubleNumberProperty () },
                            { "priceAssetInUSD", new DoubleNumberProperty () },
                            { "priceAssetOutUSD", new DoubleNumberProperty () },
                            { "feesUSD", new DoubleNumberProperty () },
                            { "feesUSDProvider", new DoubleNumberProperty () },
                            { "feesUSDProtocol", new DoubleNumberProperty () },
