namespace AVMTradeReporter.Model.DTO
{
    ...
    public class TopAssetsResponse
    {
        ...
        /// <summary>Top assets by relative real TVL growth in percent over 24h ("Top liquidity gainers"). Only positive, finite changes qualify.
        /// Newly funded assets (no TVL 24h ago) have an undefined percent change from a zero baseline and are excluded.</summary>
