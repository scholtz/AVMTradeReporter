...
kubectl apply -f subscriber-deployment.yaml -n biatec-scan
...
kubectl rollout restart deployment/avmtradereporter-subscriber -n biatec-scan
kubectl rollout status deployment/avmtradereporter-subscriber -n biatec-scan
